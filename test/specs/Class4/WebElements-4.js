 ...
 **     //tagName[starts-with(text(), "starting portion of attrName value")]
 ...
 *      find the tag(tagName) in DOM where attribute(attrName) starts-with "starting portion of text value"
 * 
 ...
 *      find the tag(tagName) in DOM text does NOT contain "partial text value" 
 * 
 *?  8. using and/or operator
 **     //tagName[not(@attrName="attr value" and text()="text value")]
 *      find the tag(tagName) in DOM which has attribute (attrName) with value as "attrName value" AND text-value 
 * 
 **     //tagName[contains(text(), "partial text val" or starts-with(text(), "starting text value")]
 *      find the tag(tagName) in DOM where text contains "partial text val" OR text-value "starting text value"
 * 
 **     //div[contains(text(), "partial text val" or starts-with(text(), "starting text value")]
 *      suppose div and button tags satisfy the conditions
